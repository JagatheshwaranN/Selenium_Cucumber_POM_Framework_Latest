...
//import com.qa.ctf.objects.Old_TicketBookingPageElements;
...
// *
// */
//public class Old_TicketBookingPage extends Old_HomePage {
//
//	private static final Logger log = LogManager.getLogger(Old_TicketBookingPage.class.getName());
//	Old_TicketBookingPageElements ticketBookingPageElements;
//
//	public Old_TicketBookingPage(WebDriver driver) {
//		super(driver);
//		this.ticketBookingPageElements = new Old_TicketBookingPageElements();
...
//	}
//
//	public Old_TicketDetailsPage bookTicket() {
//		var price = 0;
//		var lowestPrice = 0;
//		try {
...
//			Assert.fail();
//		}
//		return getInstance(Old_TicketDetailsPage.class);
//	}
//
